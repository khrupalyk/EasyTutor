...
<div class="jumbotron" style="margin: 0 auto; width: 90%;">
    ...
    <ul>
        ...
        <li>Можливість використання системи під час здачі тесту (більше <a>тут</a>)</li>
    </ul>
    </p>
    <p></p>
    ...
    <p>Залишились питання? Маєш пропозиції як вдосконалити проект? Хочеш зробити свій внесок в розвиток проекту? Тоді тобі <a>соди</a>!</p>
    <p ><span class="ps">P.S. Система розробляється у вільний від роботи та навчання час, тому велике прохання, якщо Ви знайшли помилку у її роботі, <a>сповістіть про це адміністратора</a>, щоб він міг оперативно її усунути.</span></p>
</div>
